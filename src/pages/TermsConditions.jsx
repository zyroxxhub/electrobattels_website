  ...
  return (
    <div className="min-h-screen bg-studio-black text-[#F5ECD7]">
      ...
      <div className="relative overflow-hidden bg-studio-charcoal border-b border-studio-gold/10 pt-28 pb-16">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(201,168,76,0.10)_0%,_transparent_65%)] pointer-events-none" />
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-10 h-10 rounded-full bg-studio-gold/10 border border-studio-gold/20 flex items-center justify-center">
              <FileText className="w-5 h-5 text-studio-gold" />
            </div>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-12">
        ...
        <TermsSection number="4" title="Cancellation & Refund Policy">
          ...
          <ul>
            <li><strong className="text-[#F5ECD7]/80">Academy-initiated cancellations:</strong> If we cancel a class, a full refund or equivalent credit will be offered.</li>
            <li><strong className="text-[#F5ECD7]/80">Student-initiated cancellations:</strong> Cancellations made more than 7 days before the term begins may receive a partial refund at our discretion.</li>
            <li><strong className="text-[#F5ECD7]/80">No-shows:</strong> Missed classes are non-refundable and cannot be transferred.</li>
          </ul>
        </TermsSection>
        ...
        <section className="bg-studio-charcoal/60 border border-studio-gold/10 rounded-2xl p-8">
          <h2 className="font-accent text-lg text-studio-gold mb-4">Questions?</h2>
